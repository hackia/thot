...
impl Emitter {
    ...
    fn emit_addr32_prefix(&self, code: &mut Vec<u8>) {
        if !self.pmode_enabled {
            code.push(0x67);
        }
    }
    ...
    pub fn generer_binaire(&mut self, is_bootloader: bool) -> Vec<u8> {
            ...
            match instruction {
                ...
                Instruction::Label(nom) => {
                    ...
                    if (nom == "kernel" || nom == "noyau") && !pmode_inserted {
                        ...
                        pmode_entry_addr =
                            Some((prologue_base + pmode_entry_off as isize) as u32);
                        pmode_inserted = true;
        ...
        let xenith_add = vec![
            ...
            0x8B, 0x47, 0x04, 0x13, 0x46, 0x04, 0x89, 0x47, 0x04,
            0x8B, 0x47, 0x08, 0x13, 0x46, 0x08, 0x89, 0x47, 0x08,
            0x8B, 0x47, 0x0C, 0x13, 0x46, 0x0C, 0x89, 0x47, 0x0C,
            0x8B, 0x47, 0x10, 0x13, 0x46, 0x10, 0x89, 0x47, 0x10,
            0x8B, 0x47, 0x14, 0x13, 0x46, 0x14, 0x89, 0x47, 0x14,
            0x8B, 0x47, 0x18, 0x13, 0x46, 0x18, 0x89, 0x47, 0x18,
            0x8B, 0x47, 0x1C, 0x13, 0x46, 0x1C, 0x89, 0x47, 0x1C,
            0x73, 0x1C, // JNC +28 (skip saturation)
            0xB8, 0xFF, 0xFF, 0xFF, 0xFF,
            0x89, 0x07, 0x89, 0x47, 0x04, 0x89, 0x47, 0x08, 0x89, 0x47,
            0x0C, 0x89, 0x47, 0x10, 0x89, 0x47, 0x14, 0x89, 0x47,
            0x18, 0x89, 0x47, 0x1C,
            0x61, 0xC3,
        ];
        ...
        let helix_mul = vec![
            0x60, // PUSHAD
            // RA (0..7)
            0x31, 0xED, 0x8B, 0x07, 0xF7, 0x26, 0x89, 0xC3, 0x89, 0xD1,
            0x8B, 0x07, 0xF7, 0x66, 0x04, 0x0B, 0xEA, 0x50,
            0x8B, 0x47, 0x04, 0xF7, 0x26, 0x0B, 0xEA, 0x50,
            0x8B, 0x47, 0x04, 0xF7, 0x66, 0x04, 0x0B, 0xEA, 0x0B, 0xE8,
            0x5A, 0x58, 0x01, 0xC1, 0x83, 0xD5, 0x00, 0x01, 0xD1,
            0x83, 0xD5, 0x00, 0x85, 0xED, 0x75, 0x07,
            0x89, 0x1F, 0x89, 0x4F, 0x04, 0xEB, 0x0A,
            0xB8, 0xFF, 0xFF, 0xFF, 0xFF, 0x89, 0x07, 0x89, 0x47, 0x04,
            // Apophis (8..15)
            0x31, 0xED, 0x8B, 0x47, 0x08, 0xF7, 0x66, 0x08, 0x89, 0xC3,
            0x89, 0xD1, 0x8B, 0x47, 0x08, 0xF7, 0x66, 0x0C, 0x0B, 0xEA,
            0x50, 0x8B, 0x47, 0x0C, 0xF7, 0x66, 0x08, 0x0B, 0xEA, 0x50,
            0x8B, 0x47, 0x0C, 0xF7, 0x66, 0x0C, 0x0B, 0xEA, 0x0B, 0xE8,
            0x5A, 0x58, 0x01, 0xC1, 0x83, 0xD5, 0x00, 0x01, 0xD1,
            0x83, 0xD5, 0x00, 0x85, 0xED, 0x75, 0x08,
            0x89, 0x5F, 0x08, 0x89, 0x4F, 0x0C, 0xEB, 0x0B,
            0xB8, 0xFF, 0xFF, 0xFF, 0xFF, 0x89, 0x47, 0x08, 0x89, 0x47, 0x0C,
            0x61, 0xC3,
        ];
        ...
        let helix_and = vec![
            0x60, // PUSHAD
            0x8B, 0x07, 0x23, 0x06, 0x89, 0x07,
            0x8B, 0x47, 0x04, 0x23, 0x46, 0x04, 0x89, 0x47, 0x04,
            0x8B, 0x47, 0x08, 0x23, 0x46, 0x08, 0x89, 0x47, 0x08,
            0x8B, 0x47, 0x0C, 0x23, 0x46, 0x0C, 0x89, 0x47, 0x0C,
            0x61, 0xC3,
        ];
        ...
        let helix_or = vec![
            0x60, // PUSHAD
            0x8B, 0x07, 0x0B, 0x06, 0x89, 0x07,
            0x8B, 0x47, 0x04, 0x0B, 0x46, 0x04, 0x89, 0x47, 0x04,
            0x8B, 0x47, 0x08, 0x0B, 0x46, 0x08, 0x89, 0x47, 0x08,
            0x8B, 0x47, 0x0C, 0x0B, 0x46, 0x0C, 0x89, 0x47, 0x0C,
            0x61, 0xC3,
        ];
        ...
        let helix_cmp = vec![
            0x60, // PUSHAD
            0x8B, 0x07, 0x03, 0x46, 0x08, 0x8B, 0x5F, 0x04, 0x13, 0x5E, 0x0C,
            0x0F, 0x92, 0xC1,
            0x8B, 0x16, 0x03, 0x57, 0x08, 0x8B, 0x6E, 0x04, 0x13, 0x6F, 0x0C,
            0x0F, 0x92, 0xC5,
            0x38, 0xE9, 0x75, 0x08, 0x39, 0xEB, 0x75, 0x03, 0x39, 0xD0,
            0x61, 0xC3,
        ];
        ...
        if pmode_inserted {
            ...
            let gdt: Vec<u8> = vec![
                ...
                0xFF, 0xFF, 0x00, 0x00, 0x00, 0x9A, 0xCF, 0x00, // code (32-bit, base 0, limit 4GB)
                0xFF, 0xFF, 0x00, 0x00, 0x00, 0x92, 0xCF, 0x00, // data (32-bit, base 0, limit 4GB)
                0xFF, 0x0F, 0x00, 0x80, 0x0B, 0x92, 0x00, 0x00, // vga (base 0xB8000, limit 4KB)
            ];
        ...
        for patch in &self.jump {
            let base = if patch.kernel { base_stage2 } else { base_stage1 };
